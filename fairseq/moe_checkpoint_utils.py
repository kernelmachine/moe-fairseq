...
def initialize_moe_from_opt(output_dir, num_experts_per_gpu, num_gpus, path_to_opt, path_to_expert_state_dict):
    ...
    expert_state_dict = torch.load(path_to_expert_state_dict)
