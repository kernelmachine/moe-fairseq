...
echo $MOE_EVAL_CAPACITY_TOKEN_FRACTION;
...
python -m fairseq_cli.eval_lm \
  ...
  --gen-subset valid/C4_small \
  --sample-break-mode eos_pad_8 \
  --merges-filename /checkpoint/margaretli/data/opt/120321/tokenizers/gpt2-merges.txt \
  --vocab-filename /checkpoint/margaretli/data/opt/120321/tokenizers/gpt2-vocab.json \
